...
#showbookdetails #showbookdetails_chil2 #product h2 {font-weight: bold;font-size: 20px;border-bottom: 1px dashed #cfcfcf;}
...
#showbookdetails #showbookdetails_chil2 #product .infos .buy  input {
	border-radius: 10px;
  		...
  		<div id="showbookdetails_chil2">
  			<div id="product" class="main">
				<h2>铁三角 Audio-Technica ATH-EQ300M-SV 银色 挂耳式耳机</h2>
					<div class="infos">
						<div class="thumb" style="overflow: hidden;"><img src="${pageContext.request.contextPath}/images/product/spark.jpg" width="146" height="149"
						...
						<div class="buttons" style="clear:both; border: 3px solid red; height:40px;" align="right" >
							<input type="button" name="button" value="立即购买" onclick="goBuy(${product.bid})" style="
	height:40px;
	width:100px;
	border-radius: 10px;
    background: -webkit-linear-gradient(top, #66B5E6, #fc7e31);
